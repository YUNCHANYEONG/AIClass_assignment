...
<body>
    ...
    <form action="./info_ok.jsp" method="post" name="regform" id="regform" onsubmit="return sendit()">
        ...
        <p>주민등록번호 : <input type="text" name="ssn1" id="ssn1" maxlength="6" value="<%=mem_ssn1%>" readonly> - <input type="text" name="ssn2" id="ssn2" maxlength="7" value="<%=mem_ssn2%>" readonly></p>
